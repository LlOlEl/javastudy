...
public class MainClass {
	 ...
	 *  3. 변수도 메모리에 생성된다.
	 *  4. 메모리는 1바이트마다 16진수로 된 고유의 번호를 부여해서 관리한다.
	 *  	1) 주소값
	 *  	2) 참조값	
	 *  	3) 16진수 작성 에시 : 0x123abc456
	 */
	 ...
	 *  3. Snake  Case : 각 단어의 연결을 밑줄(_)로 하는 방식		 
	 *  (상수)
	 */
	 ...
	 * 			(2) 8가지 타입이 제공됨
	 * 				byte, short, int, long, float, double, char, booolean
	 * 		2) 참조 자료형(타입)
	...
	byte myFirstVariable = 127; // -128 ~ +127 까지만 저장됨 나머지는 쓰레기처럼 저장됨
	...
	// long : 8바이트 정수
	long c = 100000000000L; //뒤에 L 붙이면 8바이트로 저장해줌 long int 구분법으로 사용해도됨
	 ...
	 */
	String s = "Hello World"; //s에는 hello world의 참조값을 가지고 있는것
